/**
 * Championship Service Worker v3.0
 * Advanced Caching and Offline Experience for Texas Football Authority
 * Built for Blaze Intelligence - Championship Analytics That Never Sleep
 */

const CACHE_NAME = 'blaze-championship-v4.0';
const STATIC_CACHE = 'blaze-static-v4.0';
const DYNAMIC_CACHE = 'blaze-dynamic-v4.0';
const VIDEO_CACHE = 'blaze-video-v4.0';
const DATA_CACHE = 'blaze-data-v4.0';

// Championship assets to cache immediately
const CHAMPIONSHIP_ASSETS = [
    '/',
    '/index.html',
    ...
    '/live-demo.html',
    '/pricing.html',
    '/js/blaze-video-ai-engine.js',
    '/js/enhanced-contact-engagement.js',
    '/js/advanced-analytics-dashboard.js',
    '/js/blaze-three-visuals.js',
    '/css/blaze-championship.css',
